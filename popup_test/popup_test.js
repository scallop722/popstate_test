...
document.getElementById("imageModal").addEventListener("click", () => {
  ...
  modalTag.id = 'modal';
  modalTag.innerHTML = inlineContainerWrap;
  document.getElementsByTagName('body')[0].insertAdjacentElement('beforeend', modalTag);

  let imageModal = document.createElement('div');
  imageModal.id = 'modal-content';
  imageModal.innerHTML = `
    <div class="p-banner">
      <img src="./sample.png" width="320" height="480" />
    </div>`;
  document.getElementById('modal__content').insertAdjacentElement('beforeend', imageModal);
...
document.getElementById("iframeModal").addEventListener("click", () => {
  ...
  iframeModal.width = "360";
  iframeModal.height = "580";
  iframeModal.style = "background-color : #fff";
  iframeModal.src = "./sample.html";
  document.getElementById('modal__content').insertAdjacentElement('beforeend', iframeModal);
